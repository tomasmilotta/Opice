...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pon 29. lis 2021, 22:41
...
CREATE TABLE `clanky` (
  ...
  `clanek_zpravaRedaktora` varchar(250) NOT NULL DEFAULT '''Zatím bez posudku''',
  `clanek_zpravaSefredaktora` varchar(250) DEFAULT '''Zatím bez posudku''',
  `clanek_zpravaRecenzenta` char(250) NOT NULL DEFAULT '''Zatím bez posudku''',
  `clanek_rok` int(11) DEFAULT NULL
...
(16, 13, 'Článek 1', 'Francouzská-revoluce-2.docx', b'0', b'0', 1, 1, NULL, 'Nedostatečné', '', 'Dostatečné', NULL),
(17, 13, 'Článek 2', 'Francouzská-revoluce-2.docx', b'1', b'1', 5, 1, 1, 'Zatím bez posudku', '', 'Zatím bez posudku', 2021),
...
(20, 15, 'Šachy', 'cv5 (3).docx', b'1', b'1', 5, 1, 1, 'Dobré', '', 'Dobré', NULL),
...
(23, 24, 'Člověk a informační technologie', 'posudek.pdf', b'0', b'0', 2, 1, NULL, 'Velmi dobré', NULL, 'Zatím bez posudku', NULL);
...
(28, 'Daniel', 'Brož', 'broz07', '60102ccd3735e1c0b5eb3b40a3bc0c83c2b1121820920a90a3bf8dde027eadc0', 2, 'broz07@student.vspj.cz', 'user.jpg');
...
--
ALTER TABLE `clanky`
  MODIFY `clanek_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
